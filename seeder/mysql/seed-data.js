...
exports.seedUserRoles = async (connection, requestID) => {
  try {
    logger.info(
      ...
      "seed-tables",
      "seedUserRolesTable",
      "Executing MySQL Query :: Adding user_roles",
      {}
    );
    ...
    logger.error(requestID, "seed-tables", "seedUserRolesTable", "Error", {
...
exports.seedRootUser = async (connection, requestID) => {
  try {
    ...
    logger.info(
      ...
      "seed-tables",
      "seedRootUser",
      "Executing MySQL Query :: Adding root user",
      {}
    );
    await connection.query(
      `
    ...
    logger.error(requestID, "seed-tables", "seedRootUser", "Error", {
      error: error.toString(),
    });
    throw new Error(error);
  }
