...
exports.createUsersTable = async (connection, requestID) => {
  try {
    logger.info(
      ...
      "create-tables",
      "createUsersTable",
      `Creating table "users" :: Executing MySQL Query`,
      {}
    );
    await connection.query(
    ...
    logger.error(requestID, "create-tables", "createUsersTable", `Error`, {
      error: error.toString(),
    });
    throw new Error(error);
  }
...
exports.createAuthorizationTokensTable = async (connection, requestID) => {
  try {
    logger.info(
      requestID,
      "Seed",
      "createAuthorizationTokensTable",
      "Executing MySQL Query",
      {}
    );
    await connection.query(
...
exports.createUsersPinsTable = async (connection, requestID) => {
  try {
    ...
    logger.error(requestID, "Seed", "createUsersPinsTable", "Error details", {
      error: error.toString(),
    });
    throw new Error(error);
  }
